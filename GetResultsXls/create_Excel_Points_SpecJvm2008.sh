...
#读取SpecJvm2008测试结果情况，并将本组测试结果跑分情况写入Excel文件

python -c 'import write_Excel_SpecJvm2008; write_Excel_SpecJvm2008.writeResult("'$TestType'","'$Platform'","'$TestCase'","'$Node_count'")'


#function write_Excel_SpecJvm2008()
#{
#
#  #python -c 'import write_Excel_SpecJvm2008; write_Excel_SpecJvm2008.setPoint("'$TestType'","'$Platform'","'$TestCase'","'$Node_count'")'
#
#}
